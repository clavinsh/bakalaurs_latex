...
skaitļošana ar grafiskajiem procesoriem, mūsdienās ņem vērā un ievieš procesora arhitektūras līmenī}
...
{\setstretch{2.0}
\noindent
\degree \ "\@title" izstrādāts LU Eksakto zinātņu un tehnoloģiju fakultātē Datorikas nodaļā.
\newline
\newline
\noindent
...
\newline
\noindent 
Darbs iesniegts Eksakto zinātņu un tehnoloģiju fakultātē Datorikas nodaļā
\newline
\newline
\noindent 
